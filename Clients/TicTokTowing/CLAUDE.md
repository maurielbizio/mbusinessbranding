...
flowchart TD
    ...
    P1["📋 Phase 1\nDiscovery & Asset Collection\n──────────────────\n• Discovery call\n• Collect logo, photos, brand\n• Audit existing platforms\n• Confirm services & service area"]
    ...
    P5["📞 Phase 5\nAI Receptionist\n(Customer Calls)\n──────────────────\n• GHL AI Voice Agent\n• 24/7 call answering\n• FAQ handling\n• Books to owner calendar\n• SMS confirmations"]

    P2 --> P6

    P6["🚛 Phase 6\nDriver Recruitment\nPage + AI Voice Agent\n──────────────────\n• Recruitment page on site\n• Application form → GHL pipeline\n• Separate AI voice agent\n• Applicant screening flow\n• Interview booking"]

    P4 --> P7

    P7["⭐ Phase 7\nAutomated Google\nReview System\n──────────────────\n• Post-service SMS trigger\n• Review request workflow\n• 48-hr follow-up\n• Negative feedback routing\n• Review tracking in GHL"]
    ...
    style DONE fill:#16213e,color:#fff,stroke:#0f3460
    style P1 fill:#0f3460,color:#fff,stroke:#e94560
    style P2 fill:#533483,color:#fff,stroke:#e94560
    style P3 fill:#533483,color:#fff,stroke:#e94560
    style P4 fill:#533483,color:#fff,stroke:#e94560
    style P5 fill:#e94560,color:#fff,stroke:#fff
    style P6 fill:#e94560,color:#fff,stroke:#fff
    style P7 fill:#e94560,color:#fff,stroke:#fff
    style P8 fill:#0f3460,color:#fff,stroke:#e94560
```
